...
public class Items {
    ...
    private static final String RIGHT = "&e&lRight Click&7 &r";
    private static final String SHIFT_RIGHT = "&e&lShift-Right Click&7 &r";
    private static final String LEFT = "&e&lLeft Click&7 &r";
    private static final String RIGHT_OR_LEFT = "&e&lRight/Left Click&7 &r";
    private static boolean charMatches(char potential_indentifier, char[] code_identifiers) {
        for(char identifier : code_identifiers) {
            if(potential_indentifier == identifier) { return true; }
        }
        return false;
    }
    private static int encodedLength(String colored_sentence, char[]... codes) {
        ...
        List<Character> special_list = new ArrayList<Character>();
        for(char[] code : codes) {
        ...
        for(i = 0; i < sentence.length; i++) {
            ...
            if(  !( (previous_character == '&' || previous_character == '§') && charMatches(current_character, special_characters) )  ) {
    ...
    private static String getLastCode(String sentence, char[] code_identifiers) {
        ...
        for(int i = quantized_sentence.length-2; 0 <= i; i--) {
            if(quantized_sentence[i] == '&' && charMatches(quantized_sentence[i+1], code_identifiers) ) {
    ...
    private static String ability(String name, String description) {
