...
import net.typhonmc.typhfun.additions.Items;
import net.typhonmc.typhfun.additions.Recipes;
...
import net.typhonmc.typhfun.helpers.Formatter;
import net.typhonmc.typhfun.implementations.CraftingMaterials;
...
import static net.typhonmc.typhfun.additions.Recipes.getCustomItem;

public final class TyphfunPlugin extends JavaPlugin implements SlimefunAddon {

    private static List<SlimefunItem> items = new ArrayList<>();
    private static HashMap<String, SlimefunItem> mapping = new HashMap<>();

    private static TyphfunPlugin instance;
    ...
    public void onEnable() {
        ...
        /*Cheesy Bites*/ {
            ...
            items.add( new SlimefunItem(cheesy_bites, Items.SLIME_BUCKET, RecipeType.NULL, Recipes.SLIME_BUCKET) ); //RecipeType.INTERACT has Maven-related bug? (has been updated since)
            ...
            items.add( new SlimefunItem(cheesy_bites, Items.PAINTERS_BRICKS, RecipeType.NULL, Recipes.PAINTERS_BRICKS) ); //<--- RecipeType.SMITHING_PRESSs
        ...
        /*Register item implementations*/ {
            getServer().getPluginManager().registerEvents(new CraftingMaterials(), this);
